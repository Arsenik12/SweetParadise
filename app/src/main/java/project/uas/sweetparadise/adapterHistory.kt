...
class adapterHistory(private val daftarHistory: MutableList<Cart>, private val db: AppDatabase) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.rec_history, parent, false)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val dtBill = daftarHistory[position]
